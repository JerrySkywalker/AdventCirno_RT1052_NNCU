...
#define FC4_zzdbg_4_SB_AMP            14
#define FC4_zzdbg_5_fracBitsOut       10
#define FC4_zzdbg_8_AuxAct            "LINEAR"
extern const int16_t cg_FC1weit[]; // 1680 - Co, Di: (140, 12)
...
int32_t img_buffer1[(280 + 3) / 4];
int32_t col_buf[(280 + 3) / 4]; // [2, 140, 2]
...
{ 
	...
	// Block 1: Dense - dense_5
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*12*/, FC1_OY/*140*/, FC1_SB/*5*/
	...
	// Block 2: Dense - dense_6
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*140*/, FC2_OY/*100*/, FC2_SB/*13*/
	...
	// Block 4: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*40*/, FC4_OY/*1*/, FC4_SB/*12*/
