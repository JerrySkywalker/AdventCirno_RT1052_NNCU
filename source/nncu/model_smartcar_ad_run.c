...
#define FC1_SB                        5
#define FC1_SO                        8
#define FC1_zzdbg_2_SH_WT             13
#define FC1_zzdbg_3_productShf        20
...
#define FC2_SB                        12
#define FC2_SO                        13
#define FC2_zzdbg_2_SH_WT             12
#define FC2_zzdbg_3_productShf        25
#define FC2_zzdbg_4_SB_AMP            13
...
#define FC3_zzdbg_3_productShf        26
#define FC3_zzdbg_4_SB_AMP            13
...
{ 
    ...
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC1weit/*weit*/, FC1_IY/*9*/, FC1_OY/*180*/, FC1_SB/*5*/
        , FC1_SO/*8*/, cg_FC1bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
    ...
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*180*/, FC2_OY/*100*/, FC2_SB/*12*/
        , FC2_SO/*13*/, cg_FC2bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

	// Block 2: Activation - activation_4
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, ACT2_OY/*100*/, ACT2_AA/*2*/, ARM_TANH, 14);

	// Block 3: Dense - dense_7
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC3weit/*weit*/, FC3_IY/*100*/, FC3_OY/*40*/, FC3_SB/*13*/
        , FC3_SO/*16*/, cg_FC3bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
