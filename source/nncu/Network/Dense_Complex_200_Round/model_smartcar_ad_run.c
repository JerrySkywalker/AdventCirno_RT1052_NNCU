...
#define FC1_SB                        6
#define FC1_SO                        9
#define FC1_zzdbg_2_SH_WT             14
#define FC1_zzdbg_3_productShf        21
#define FC1_zzdbg_4_SB_AMP            15
...
#define FC2_SB                        12
#define FC2_SO                        15
#define FC2_zzdbg_2_SH_WT             14
#define FC2_zzdbg_3_productShf        27
#define FC2_zzdbg_4_SB_AMP            15
...
#define FC3_SB                        11
#define FC3_SO                        17
#define FC3_zzdbg_2_SH_WT             14
#define FC3_zzdbg_3_productShf        27
...
{ 
    ...
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC2weit/*weit*/, FC2_IY/*180*/, FC2_OY/*100*/, FC2_SB/*12*/
        , FC2_SO/*15*/, cg_FC2bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

	// Block 2: Activation - activation_4
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, ACT2_OY/*100*/, ACT2_AA/*2*/, ARM_TANH, 14);

	// Block 3: Dense - dense_7
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC3weit/*weit*/, FC3_IY/*100*/, FC3_OY/*40*/, FC3_SB/*11*/
        , FC3_SO/*17*/, cg_FC3bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

	// Block 3: Activation - re_lu_2
    aia_relu8_q15((int16_t*)img_buffer1/*1*/, (uint32_t)(ACT3_IX * ACT3_IY * ACT3_IC)/*1x40x1*/, ACT3_AI);

	// Block 4: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC4weit/*weit*/, FC4_IY/*40*/, FC4_OY/*1*/, FC4_SB/*5*/
        , FC4_SO/*14*/, cg_FC4bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);
