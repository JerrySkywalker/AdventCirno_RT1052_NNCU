...
#define CONV1_SX                      1
#define CONV1_SY                      1
#define CONV1_zzdbg_2_SH_WT           12
#define CONV1_zzdbg_3_productShf      19
#define CONV1_zzdbg_4_SB_AMP          13
...
#define CONV2_SX                      1
#define CONV2_SY                      1
#define CONV2_zzdbg_2_SH_WT           11
#define CONV2_zzdbg_3_productShf      24
...
#define FC3_SB                        7
#define FC3_SO                        11
#define FC3_zzdbg_2_SH_WT             13
#define FC3_zzdbg_3_productShf        23
...
{ 
    ...
    aia_convolve_HWC_q15_basic_nonsquare((int16_t*)img_buffer0/*0*/, CONV1_IX/*8*/, CONV1_IY/*1*/, CONV1_IC/*9*/
        ...
        , CONV1_SY/*1*/, cg_CONV1bias/*bias*/, CONV1_SB/*6*/, CONV1_SO/*7*/, (int16_t*)img_buffer1/*1*/, CONV1_OX/*8*/
    ...
    aia_convolve_HWC_q15_fast_nonsquare((int16_t*)img_buffer1/*1*/, CONV2_IX/*8*/, CONV2_IY/*1*/, CONV2_IC/*32*/
        ...
        , CONV2_SY/*1*/, cg_CONV2bias/*bias*/, CONV2_SB/*13*/, CONV2_SO/*14*/, (int16_t*)img_buffer0/*0*/, CONV2_OX/*8*/
    ...
    aia_depthwise_separable_conv_HWC_q15_nonsquare((int16_t*)img_buffer0/*0*/, BN2_IX/*8*/, BN2_IY/*1*/, BN2_IC/*32*/
        ...
        , cg_BN2bias/*bias*/, BN2_SB/*4*/, BN2_SO/*8*/, (int16_t*)img_buffer1/*1*/, BN2_OX/*8*/, BN2_OY/*1*/, (int16_t *) col_buf, NULL);

	// Block 3: Dense - dense_1
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_FC3weit/*weit*/, FC3_IY/*256*/, FC3_OY/*160*/, FC3_SB/*7*/
        , FC3_SO/*11*/, cg_FC3bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

	// Block 3: Dense - dense_1, auxact tanh
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, FC3_OY/*160*/, FC3_AA/*2*/, ARM_TANH, 14);

	// Block 4: Dense - dense_2
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_FC4weit/*weit*/, FC4_IY/*160*/, FC4_OY/*1*/, FC4_SB/*12*/
