...
#define FC4_zzdbg_3_productShf        30
#define FC4_zzdbg_4_SB_AMP            13
#define FC4_zzdbg_5_fracBitsOut       12
#define FC4_zzdbg_8_AuxAct            "TANH"
extern const int16_t cg_ML_CONV1weit[]; // 5760 - Co,H,W,Ci: (32, 4, 5, 9)
extern const int16_t cg_ML_CONV1bias[]; // 32
extern const int16_t cg_ML_CONV2weit[]; // 9216 - Co,H,W,Ci: (32, 3, 3, 32)
extern const int16_t cg_ML_CONV2bias[]; // 32
extern const int16_t cg_ML_BN2weit[]; // 32 - Co,H,W,Ci: (1, 1, 1, 32)
extern const int16_t cg_ML_BN2bias[]; // 32
extern const int16_t cg_ML_FC3weit[]; // 40960 - Co, Di: (160, 256)
extern const int16_t cg_ML_FC3bias[]; // 160
extern const int16_t cg_ML_FC4weit[]; // 160 - Co, Di: (1, 160)
extern const int16_t cg_ML_FC4bias[]; // 1
...
static int32_t img_buffer0[(512 + 3) / 4];
static int32_t img_buffer1[(512 + 3) / 4];
static int32_t col_buf[(1152 + 3) / 4]; // [2, 3, 3, 32, 2]
...
void* RunModel_ML(const void *in_buf)
{ 
    ...
    aia_convolve_HWC_q15_basic_nonsquare((int16_t*)img_buffer0/*0*/, CONV1_IX/*8*/, CONV1_IY/*1*/, CONV1_IC/*9*/
        , cg_ML_CONV1weit/*weit*/, CONV1_OC/*32*/, CONV1_KX/*5*/, CONV1_KY/*4*/, CONV1_PX/*2*/, CONV1_PY/*1*/, CONV1_SX/*1*/
        , CONV1_SY/*1*/, cg_ML_CONV1bias/*bias*/, CONV1_SB/*5*/, CONV1_SO/*5*/, (int16_t*)img_buffer1/*1*/, CONV1_OX/*8*/
    ...
    aia_convolve_HWC_q15_fast_nonsquare((int16_t*)img_buffer1/*1*/, CONV2_IX/*8*/, CONV2_IY/*1*/, CONV2_IC/*32*/
        , cg_ML_CONV2weit/*weit*/, CONV2_OC/*32*/, CONV2_KX/*3*/, CONV2_KY/*3*/, CONV2_PX/*1*/, CONV2_PY/*1*/, CONV2_SX/*1*/
        , CONV2_SY/*1*/, cg_ML_CONV2bias/*bias*/, CONV2_SB/*12*/, CONV2_SO/*13*/, (int16_t*)img_buffer0/*0*/, CONV2_OX/*8*/
    ...
    aia_depthwise_separable_conv_HWC_q15_nonsquare((int16_t*)img_buffer0/*0*/, BN2_IX/*8*/, BN2_IY/*1*/, BN2_IC/*32*/
        , cg_ML_BN2weit/*weit*/, BN2_OC/*32*/, BN2_KX/*1*/, BN2_KY/*1*/, BN2_PX/*0*/, BN2_PY/*0*/, BN2_SX/*1*/, BN2_SY/*1*/
        , cg_ML_BN2bias/*bias*/, BN2_SB/*5*/, BN2_SO/*8*/, (int16_t*)img_buffer1/*1*/, BN2_OX/*8*/, BN2_OY/*1*/, (int16_t *) col_buf, NULL);

	// Block 3: Dense - dense_1
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_ML_FC3weit/*weit*/, FC3_IY/*256*/, FC3_OY/*160*/, FC3_SB/*6*/
        , FC3_SO/*10*/, cg_ML_FC3bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

	// Block 3: Dense - dense_1, auxact tanh
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, FC3_OY/*160*/, FC3_AA/*2*/, ARM_TANH, 14);

	// Block 4: Dense - dense_2
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_ML_FC4weit/*weit*/, FC4_IY/*160*/, FC4_OY/*1*/, FC4_SB/*17*/
        , FC4_SO/*18*/, cg_ML_FC4bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);
