...
extern const int16_t cg_MP_FC1weit[]; // 1620 - Co, Di: (180, 9)
extern const int16_t cg_MP_FC1bias[]; // 180
extern const int16_t cg_MP_FC2weit[]; // 18000 - Co, Di: (100, 180)
extern const int16_t cg_MP_FC2bias[]; // 100
extern const int16_t cg_MP_FC3weit[]; // 4000 - Co, Di: (40, 100)
extern const int16_t cg_MP_FC3bias[]; // 40
extern const int16_t cg_MP_FC4weit[]; // 40 - Co, Di: (1, 40)
...
{ 
	...
	// Block 1: Dense - dense_5
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_MP_FC1weit/*weit*/, FC1_IY/*9*/, FC1_OY/*180*/, FC1_SB/*6*/
        , FC1_SO/*7*/, cg_MP_FC1bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

	// Block 1: Activation - activation_3
    aia_nn_activations_direct_q15((int16_t*)img_buffer1/*1*/, ACT1_OY/*180*/, ACT1_AA/*2*/, ARM_TANH, 14);

	// Block 2: Dense - dense_6
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_MP_FC2weit/*weit*/, FC2_IY/*180*/, FC2_OY/*100*/, FC2_SB/*12*/
        , FC2_SO/*12*/, cg_MP_FC2bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);

	// Block 2: Activation - activation_4
    aia_nn_activations_direct_q15((int16_t*)img_buffer0/*0*/, ACT2_OY/*100*/, ACT2_AA/*2*/, ARM_TANH, 14);

	// Block 3: Dense - dense_7
    arm_fully_connected_q15((int16_t*)img_buffer0/*0*/, cg_MP_FC3weit/*weit*/, FC3_IY/*100*/, FC3_OY/*40*/, FC3_SB/*13*/
        , FC3_SO/*15*/, cg_MP_FC3bias/*bias*/, (int16_t*)img_buffer1/*1*/, (int16_t*)col_buf);

	// Block 3: Activation - re_lu_2
    aia_relu8_q15((int16_t*)img_buffer1/*1*/, (uint32_t)(ACT3_IX * ACT3_IY * ACT3_IC)/*1x40x1*/, ACT3_AI);

	// Block 4: Dense - dense_8
    arm_fully_connected_q15((int16_t*)img_buffer1/*1*/, cg_MP_FC4weit/*weit*/, FC4_IY/*40*/, FC4_OY/*1*/, FC4_SB/*12*/
        , FC4_SO/*17*/, cg_MP_FC4bias/*bias*/, (int16_t*)img_buffer0/*0*/, (int16_t*)col_buf);
